...
function _ListItem({
  ...
  return (
    ...
    >
      <div className='c-chat_list-item-avatar' style={{ backgroundImage:`url(${avatarUrl})`,backgroundSize:'cover' }}>
      ...
      <div className='c-chat_list-item-time'>{transformTimestamp(lastMessageTime)}</div>
    </div>
  )
}
